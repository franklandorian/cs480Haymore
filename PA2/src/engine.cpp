...
bool Engine::Initialize(char* vertexFilename, char* fragmentFilename)
{
  // Start a window
  m_window = new Window();
  ...
  if(!m_graphics->Initialize(m_WINDOW_WIDTH, m_WINDOW_HEIGHT, vertexFilename, fragmentFilename))
  {
